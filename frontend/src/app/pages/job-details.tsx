...
import { MapPin, Briefcase, Clock, DollarSign, Building2, ArrowLeft, Send } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-muted">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-12 w-full flex-1">
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border p-8 mb-8">
          ...
          <button className="w-full md:w-auto bg-gradient-to-r from-primary to-blue-600 text-white px-8 py-3 rounded-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2">
